<template>
  <f7-page>
    <f7-navbar title="选择主题" back-link="Back"></f7-navbar>
    <f7-block-title>APP 整体颜色</f7-block-title>
    <f7-block>
      <p>APP 主题颜色, 搭配下面的配色会更好看哦(PS: 该功能还在测试阶段).</p>
      <f7-row>
    ...
    <f7-block-title>APP 按钮颜色</f7-block-title>
    <f7-block>
      <p>APP 按钮颜色</p>
      <f7-row>
