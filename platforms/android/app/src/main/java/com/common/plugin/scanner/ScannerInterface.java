...
scan_start ����ɨ��ͷ����ɨ���, ������� scan_stop �ָ�ɨ��ͷ״̬��
	...
	//KEY_FILTERCHARACTER_ACTION  //�����ض��ַ�
	...
	//KEY_FAILUREBROADCAST_ACTION ɨ��ʧ�ܹ㲥
